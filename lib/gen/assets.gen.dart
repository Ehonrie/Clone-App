...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/fab2.svg
  SvgGenImage get fab2 => const SvgGenImage('assets/icons/fab2.svg');
  ...
  /// File path: assets/icons/library_active.svg
  SvgGenImage get libraryActive =>
      const SvgGenImage('assets/icons/library_active.svg');

  /// File path: assets/icons/market.svg
  SvgGenImage get market => const SvgGenImage('assets/icons/market.svg');

  /// File path: assets/icons/market_active.svg
  SvgGenImage get marketActive =>
      const SvgGenImage('assets/icons/market_active.svg');

  /// File path: assets/icons/obscure_eye.svg
