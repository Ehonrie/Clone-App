...
class PastQuestionOptionView extends StatefulWidget {
  final List<String> selectedSubjects;
  const PastQuestionOptionView({super.key, required this.selectedSubjects});

  @override
  State<PastQuestionOptionView> createState() => _PastQuestionOptionViewState();
}

class _PastQuestionOptionViewState extends State<PastQuestionOptionView> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "SELECT ANY SUBJECT YOU WISH TO VIEW THE SYLLABUS",
      ...
      bottomSheet: Container(
        ...
        child: GestureDetector(
          onTap: () {
            ...
            Navigator.pushNamed(context, RoutesManager.subjectQuestionRoute);
          },
          child: Container(
